...
export const BentoGridItem = ({
  ...
  return (
    <div
      className={cn(
        "row-span-1 relative rounded-xl group/bento hover:shadow-xl transition duration-200 shadow-input dark:shadow-none p-4 dark:bg-beige dark:border-darkbrown bg-white border-2 border-transparent justify-between flex flex-col space-y-4",
        className
      )}
    >
      {header}
