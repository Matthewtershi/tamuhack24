import { BackSide, BufferAttribute, Color, Mesh, ShaderMaterial, LineBasicMaterial, LineSegments, MeshPhongMaterial, SphereGeometry, SRGBColorSpace, TextureLoader, Float32BufferAttribute, BufferGeometry, CylinderGeometry, Matrix4, MeshLambertMaterial, Object3D, Vector3, CubicBezierCurve3, Curve, Group, Line, NormalBlending, QuadraticBezierCurve3, TubeGeometry, DoubleSide, MeshBasicMaterial, CircleGeometry, Euler, Vector2 } from 'three';
    ...
    threeDigest(state.heatmapsData, state.scene, {
      ...
      updateObj: function updateObj(obj, d) {
        ...
        var applyUpdate = function applyUpdate(td) {
          ...
          // Set altitudes
          var altScale = scaleLinear([0, maxVal], [baseAlt, topAlt || baseAlt]);
          obj.geometry.setAttribute('position', array2BufferAttr(kdeVals.map(function (val, idx) {
            var _vertexGeoCoords$idx = _slicedToArray(vertexGeoCoords[idx], 2),
    ...
    threeDigest(state.pathsData, state.scene, {
      ...
      updateObj: function updateObj(group, path) {
        ...
        var applyUpdate = function applyUpdate(td) {
          ...
          if (useFatLine) {
            var _ref2;
            obj.geometry.setPositions((_ref2 = []).concat.apply(_ref2, _toConsumableArray(kPoints.map(function (_ref3) {
              var x = _ref3.x,
                y = _ref3.y,
                z = _ref3.z;
              return [x, y, z];
...
function fromKapsule (kapsule) {
  ...
  var FromKapsule = /*#__PURE__*/function (_baseClass) {
    function FromKapsule() {
      ...
      _this.__kapsuleInstance = kapsule.apply(void 0, args).apply(void 0, [].concat(_toConsumableArray(initKapsuleWithSelf ? [_this] : []), args));
      return _this;
    }
